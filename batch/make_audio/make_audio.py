...
#         # 日本語MP3
#         jp_file = JP_DIR / f"{explanation_id}.mp3"
#         text_to_mp3(jp_text, "ja-JP", jp_file)

#         # 英語翻訳 → MP3
#         en_text = translate_ja_to_en(jp_text)
#         en_file = EN_DIR / f"{explanation_id}.mp3"
#         text_to_mp3(en_text, "en-US", en_file)
